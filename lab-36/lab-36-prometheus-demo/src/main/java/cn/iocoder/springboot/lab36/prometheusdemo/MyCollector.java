...
public class MyCollector extends Collector {
    ...
    public List<MetricFamilySamples> collect() {
        ...
        Sample random = new Sample("rand_dis", Arrays.asList("symbol"), Arrays.asList("random"), Math.random()*1000,time-(long)(Math.random()*1000*60*30));
        MetricFamilySamples rand = new MetricFamilySamples("rand_dis", Type.UNTYPED, "Count of completed GC cycles generated by the Go runtime.", Arrays.asList(random));
